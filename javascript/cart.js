    ...
    for (var i = 0; i < cartBoxes.length; i++) {
        ...
        var orderContentHtml = `
            <img src="${imgSrc}" alt="not found" class="img-order">
              <input type="hidden" name="food_id${i+1}" value="${food_id}"  readonly>
               <input type="hidden" name="rest_id${i+1}" value="${rest_id}"  readonly>
              
            <div class="detail-order">
                <div class="product-title">${title}</div>
                <div class="product-quantity">
                quantity: <input type="number" name="quantity${i+1}" style="border-color: transparent; background-color: transparent;" class="quantityNum" value="${quantity}" readonly>
                 
               
            </div>
             <input type="hidden" name="number_item" value="${number_item}"  readonly></div>  
        `;
