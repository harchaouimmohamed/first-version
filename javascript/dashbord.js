...
/*  const rows = document.querySelectorAll('.ordercostumer');
  ...
  // Move content from sourceSpan to targetSpan
  var contentToMove = sourceSpan.innerHTML;
  targetSpan.innerHTML = contentToMove;

  // Optionally, clear content from sourceSpan
